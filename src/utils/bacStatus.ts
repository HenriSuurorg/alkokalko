const joobeastmed = [
  ...
  },
  {
    promile: 1,
    description:
      'Tunned ennast eufoorilisena, kuid sinu motoorsed võimed, koordinatsioon, reaktsiooniaeg ja tasakaal on juba tugevalt häiritud. Samuti arutlusvõime ning mälu. Tõenäoliselt sa ei mäleta, mitu jooki oled juba joonud. Sinu emotsioonid on võimendunud. Osad inimesed muutuvad väga valjuhäälseks ja agressiivseks.',
  },
  {
    promile: 1.3,
    description:
  ...
  },
  {
    promile: 4,
    description:
      'Südame töö ja hingamine on häiritud. Oled tõenäoliselt koomas või juba surnud.',
  },
  {
    promile: 0,
    description:
      'Võid tunda varem tarbitud alkoholi tõttu iiveldust või peavalu.',
  },
];
